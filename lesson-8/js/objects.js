...
const person = {
    ...
    age: 28,
    gender: "female",
    interests: ["music", "running", "painting"],
    greeting() {
        let greeting = `Hi, my name is ${this.name.first} ${this.name.last} and I am ${this.age} years old. One of my interests is ${this.interests[2]}.`;
        return greeting;
    }
};
...
person.name.first = "Maria Catalina";
person.age = 25;
