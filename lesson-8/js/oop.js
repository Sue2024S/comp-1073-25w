...
function Album(name, artist, year, numTracks) {
    ...
    this.describe = function() {
        let description = `The album ${this.name} by ${this.artist} was released in ${this.year} and has ${this.numTracks} tracks.`;
        return description;
    };
};
...
const album1 = new Album("Disintegration", "The Cure", 1998, 12);
const album2 = new Album("Substance", "New Order", 1997, 24);
