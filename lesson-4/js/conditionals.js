...
function setWeather() {
	...
	if (choice == "sunny" ) {
		icon.setSttribute("src", "images/sunny.svg");
		// Check temperature
		if (temperature >= 15) {
		...
		icon.setSttribute("src", "images/rainy.svg");
	} else if (choice === "windy") {
		icon.setSttribute("src", "images/windy.svg");
	} else {
...
coffeBreak ? breakMessage.textContent = "Break time!" : breakMessage.textContent = "Keep working.";
